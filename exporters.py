...
class WordExporter:
    ...
    def generate(intelligence_object, output_dir=None):
        ...
        is_qanapi = "QANAPI" in workflow or "QANAPI" in title_text.upper()
        branding_prefix = "QANAPI x KORUM-OS" if is_qanapi else "KORUM-OS INTERNAL"
        ...
        if is_quantum:
            ...
            node_desc = "Qanapi Armory Federated Node" if is_qanapi else "KORUM-OS Secure Kernel Enclave"
            run = p.add_run(
