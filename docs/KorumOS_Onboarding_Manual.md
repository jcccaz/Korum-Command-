...
## 12. Validated Intelligence Estimate (VIE)
---
The **Validated Intelligence Estimate (VIE)** (highlighted in yellow at the bottom of the results) is the final, authoritative intelligence brief that reconciles and weighs the council's entire deliberation.
...
- **The Validated Intelligence Estimate (VIE) is not a summary** — it's a new analysis. Read it as the council's final verdict.
